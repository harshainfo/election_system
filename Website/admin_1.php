                    ...
                    if ($result->rowCount() > 0) {
                        ...
                        foreach($result as $row) {
                            ...
                            <tr>
                                ...
                                <td><?=$row["email"]?></td>
                                <td><?=$row["role"]?></td>
                                <td><button type="button" class="btn btn-primary" id="edi<?php echo $row["party_id"] ?>" onclick="buttonEditUserAction(this.id)">Edit</button>
                                    <button type="button" class="btn btn-danger" id="del<?php echo $row["party_id"] ?>" onclick="buttonDeleteUserAction(this.id)">Delete</button>
                                </tr>
