  ...
  <div class="container-fluid">
    ...
    <div class="row" id="page-content">
      ...
      <img src="Pictures/vote.jpg" id="vote_img" class="img-fluid">
			...
			<?php
				$db = mysqli_connect("localhost","root","root","emsdb",3306);
				if($db->connect_error)
				{
					die("Connection Fail: " .$db->connect_error);
				}
				$result = $db->query("SELECT * FROM `user` WHERE `username` = '{$_POST['username']}' and `password` = '{$_POST['pwd']}';");
				if($result == FALSE)
				{
				...
				else
				{
					...
					echo "<a href='loginresult.php'>Please Try Again</a>";
				}
				?>
  </div>
</div>
