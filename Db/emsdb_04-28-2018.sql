...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2018 at 06:06 PM
...
--
-- Dumping data for table `egu_city`
--

INSERT INTO `egu_city` (`city_id`, `city_name`, `egu_id`) VALUES
(1, 'Iowa City', 3);
...
--
-- Dumping data for table `egu_congredist`
--

INSERT INTO `egu_congredist` (`district_id`, `district_name`, `egu_id`) VALUES
(1, 'Congressional District 32', 4);
...
--
-- Dumping data for table `egu_county`
--

INSERT INTO `egu_county` (`county_id`, `county_name`, `egu_id`) VALUES
(1, 'Johnson', 2);
...
--
-- Dumping data for table `egu_main`
--

INSERT INTO `egu_main` (`egu_id`, `egu_type`) VALUES
(1, 'state'),
(2, 'county'),
(3, 'city'),
(4, 'Congr_Dist');
...
--
-- Dumping data for table `egu_state`
--

INSERT INTO `egu_state` (`state_id`, `state_name`, `egu_id`) VALUES
(1, 'IA', 1);
